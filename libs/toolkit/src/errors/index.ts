  ...
  throw new HttpException(
    {
      ...
      message:
        msg ||
        'Invalid authorization data specified in the request, or access to the requested resource is denied.',
    },
  ...
  throw new HttpException(
    {
      ...
      message:
        msg || 'Authorization information is not specified in the request',
    },
...
export const throwLimitedUnAuthorized = (msg: string | null = null) => {
  throw new HttpException(
    {
      status: HttpStatus.UNAUTHORIZED,
      message: msg || 'Access is restricted, please contact the operator',
    },
    HttpStatus.UNAUTHORIZED,
  );
};
